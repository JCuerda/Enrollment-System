<?php
    ...
    if( isset($_GET['alert']) ) {
      ...
      if( !$newStudent_courseID || !$newStudent_fName ||  !$newStudent_lastName ||  !$newStudent_mName || !$newStudent_address || !$newStudent_age || !$newStudent_gender || !$newStudent_contactNumber || !$newStudent_emailAdd){
          ...
          header('Location: enroll_now_manila.php?alert=blank_input&branch='.$the_branch);

      } else if( !ctype_alpha($newStudent_fName) || !ctype_alpha($newStudent_lastName) || !ctype_alpha($newStudent_mName) ){
          header('Location: enroll_now_manila.php?alert=invalid_name&branch='.$the_branch);
      } else if( !ctype_digit($newStudent_contactNumber) ){
          header('Location: enroll_now_manila.php?alert=invalid_contact_number&branch='.$the_branch);
      } else {
        ...
        if( !$newStudent_result ){
          ...
          $curriculum_enrollment_query = "SELECT tbl_subject.subject_code, 
              ...
              $result = mysqli_query($conn,$curriculum_enrollment_query);
                ...
                header('Location: enroll_now_manila.php?alert=enrollment_success&branch='.$the_branch); 
        }
     }
 }
...
?>
             ...
             <div class="row">
                    <div class="col-md-12">
                      <ol class="breadcrumb">
                          ...
                          <li><a href="enroll_now.php?branch=<?php echo $the_branch; ?>">Enrollment </a></li>
  ...
  <?php echo $errorMsg; ?>
     <div class="panel panel-success">
        <div class="panel-heading"><strong>Enrollment Form: <?php echo $the_branch; ?></strong></div>
