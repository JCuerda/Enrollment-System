<?php
    ...
    if( isset($_POST['btnSubmit']) ){
        ...
        if( $branch_id == 1 ){
            header('Location:enrolled_year.php?branch_id='.$branch_id.'&course_id='.$course_id.'&year_level='.$year_id);
        } else {
            header('Location:enrolled_year_manila.php?branch_id='.$branch_id.'&course_id='.$course_id.'&year_level='.$year_id);
        }
    }
...
?>        
     <div class="container" id="mainContainer">
        ...
        <div class="panel-heading">View Enrolled Student : Choose Branch and Year Level</div>
