                ...
                <div class="row">
                    <div class="col-md-12">
                      <ol class="breadcrumb">
                          ...
                          <li><a href="../admin/manage_choose_branch.php">Manage Student : Manila</a></li>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                              ...
                              $query = "SELECT studInfo.studentNo, 
                                        ...
                                        studInfo.status 
                                        FROM icc_prac3.tbl_studentinfo_manila studInfo 
                           ...
                           ?>
                                         <td class="text-center">
                                          ...
                                          <td class="text-center">
                                              <a href = "../admin/student_update_manila.php?student_number=<?php {echo $student_number; }?>" role="button"> <i class="fa fa-pencil-square"></i></a>
                                          </td>
