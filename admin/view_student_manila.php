   ...
   if( isset($_GET['student_number']) ){
    ...
    if( isset($_POST['btn_create']) ){
        ...
        $query = "INSERT INTO icc_prac3.login_manila(
            ...
            if( !$result ){
                header('Location: view_student_manila.php?student_number='.$the_student_number .'&emailAdd='.$the_student_email.'&alert=error');
            } else {
               header('Location: view_student_manila.php?student_number='.$the_student_number .'&emailAdd='.$the_student_email.'&alert=success');
            }
    }
