<?php
    ...
    //   $grant_id = validateFormData($_POST['grant']);

    //   $query = "UPDATE icc_prac3.tbl_studentinfo
    //             SET tbl_studentinfo.grant_id = '$grant_id'
    ...
    //   $result = mysqli_query($conn , $query);
        ...
        $update_query = "UPDATE icc_prac3.tbl_studentinfo
                        SET tbl_studentinfo.grant_id = '$grant_id'
                        WHERE tbl_studentinfo.studentNo = '$the_student_number'";
        ...
        <div class="row">
            <div class="col-md-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="../admin/student_update.php">Edit Scholarship Grant</a></li>
                    </ol> 
            </div>
        </div>
