                ...
                <div class="row">
                    <div class="col-md-12">
                      <ol class="breadcrumb">
                          ...
                          <li><a href="../admin/edit_student_info_choose_branch.php">Edit Student : Caloocan</a></li>
                        ...
                        <div class="container-fluid">
                           ...
                           ?>
                                         <td class="text-center">
                                          ...
                                          <td class="text-center">
                                              <a href = "../admin/edit_student_info.php?student_number=<?php {echo $student_number; }?>" role="button"> <i class="fa fa-pencil-square"></i></a>
                                          </td>
