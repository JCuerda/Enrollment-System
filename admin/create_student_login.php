<?php
    ...
    if( isset($_POST['btn_submit']) ){
          ...
          if( $newUser === '' || $newpass  ==='' || $new_pass ==='' ){
            ...
            $alertMessage = "<div class='row'><div class='col-md-12'><div class='alert alert-danger'>
          ...
          } else if( $newpass === $new_pass && !empty($newpass) && !empty($new_pass)){
              $role= 'user';
              ...
              if( !$result ){
                ...
                header('Location:create_student_login.php?alert=success');
              } 
                ...
                <div class="row">
                    <div class="col-md-12">
                      <ol class="breadcrumb">
                          ...
                          <li><a href="../admin/create_student_login.php">Create Login Account : Caloocan</a></li>
                      </ol>
                    </div>
                </div>
                                   ...
                                   <div class="panel panel-success" ">
                                    ...
                                    <div class="panel-body"> 
                                          ...
                                          <?php 
                                            ...
                                            $query = "SELECT tbl_studentinfo.studentNo , 
                                            ...
                                            <option class="text-center" value="<?php echo  $student_number;  ?>"><?php echo  $student_number.'-'.$fname.' '.$mName.' '.$Lname; ?></option>
