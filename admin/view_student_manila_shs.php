        ...
        if( $_GET['alert'] == 'success' ){
         ...
         $alertMessage = "<div class='row'><div class='col-md-12'><div class='alert alert-success'>
          ...
          $alertMessage = "<div class='row'><div class='col-md-12'><div class='alert alert-danger'>
                              <strong> Error Creating Account! Username Already Existed <a class='close' data-dismiss='alert'>&times</a> </strong> 
                          </div></div></div>";
        } 
  } 
   ...
   if( isset($_GET['student_number']) ){
    ...
    if( isset($_POST['btn_create']) ){
        ...
        $query = "INSERT INTO icc_prac3.login_manila(
            ...
            if( !$result ){
                header('Location: view_student_manila_shs.php?student_number='.$the_student_number .'&emailAdd='.$the_student_email.'&alert=error');
            } else {
               header('Location: view_student_manila_shs.php?student_number='.$the_student_number .'&emailAdd='.$the_student_email.'&alert=success');
            }
    }
                ...
                <div class="row">
                    <div class="col-md-12">
                      <ol class="breadcrumb">
                          ...
                          <li><a href="../admin/enroll_student_manila.php">Student Enrollment View: Manila</a></li>
                      </ol>
                    </div>
                </div>
                                       ...
                                       if( !$result || mysqli_num_rows($result) <= 0 ){
                                          ...
                                          echo " <tr>  
                                                    <td class='text-center' colspan = '2'>
                                                      <strong>No Subject Available</strong>
                                                    </td >   
                                                </tr>";
