<?php
    ...
    if( isset($_POST['btnSubmit']) ){
        ...
        $student_number = validateFormData($_POST['student_number']);
        
        if( $branch_id == 1 ){
            header('Location:reset_password.php?id='.$student_number);
        } else {
            header('Location:reset_password_manila.php?id='.$student_number);
        }
    }
...
?>        
     <div class="container" id="mainContainer">
        <div class="row">
            <div class="col-md-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="../admin/manage_choose_branch.php">Reset Password </a></li>
                    </ol> 
            </div>
        </div>
              <?php echo  $errorMsg;  ?>
        ...
        <div class="panel-heading">Manage Student : Reset Password </div>
        ...
        <br><br>
         ...
         <form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
           <div class="panel-content">
            ...
            <div class="form-group">
              <label class="col-md-4 control-label" for="student_number">Student Number:</label>
              <div class="col-md-4">
                <input type="text" id="student_number" name="student_number" class="form-control input-md">
              </div>
            </div>
