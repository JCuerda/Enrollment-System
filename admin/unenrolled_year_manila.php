...
if(isset( $_GET['alert'] )){
  ...
  if( isset($_GET['branch_id']) && isset($_GET['course_id']) && isset($_GET['year_level']) ){
    ...
    header('Location:unenrolled_choose_branch.php');
                ...
                <div class="row">
                    <div class="col-md-12">
                      <ol class="breadcrumb">
                          ...
                          <li><a href="../admin/unenrolled_choose_branch.php">Unenrolled : Manila</a></li>
                          <li><a href="../admin/unenrolled_year_manila.php">Unenrolled Student</a></li>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                              ...
                              $query = "SELECT studInfo.studentNo, 
                                        ...
                                        AND studInfo.status = 'Not Enrolled'
                                        AND studInfo.course_id = '$the_course_id' 
                                        ORDER BY studInfo.year_level , 
                                        studInfo.semester_num";
