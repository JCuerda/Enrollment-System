<?php
    ...
    if( isset($_POST['btnSubmit']) ){
      ...
      if( !$newStudent_fName ||  !$newStudent_lastName ||  !$newStudent_mName || !$newStudent_address || !$newStudent_age || !$newStudent_gender || !$newStudent_contactNumber || !$newStudent_emailAdd){
          ...
          $newStudentinfo_query = "UPDATE icc_prac3.tbl_studentinfo_manila 
                                  SET tbl_studentinfo_manila.first_name = '$newStudent_fName',
                                  tbl_studentinfo_manila.last_name = '$newStudent_lastName', 
                                  tbl_studentinfo_manila.middle_name = '$newStudent_mName',  
                                  tbl_studentinfo_manila.address = '$newStudent_address', 
                                  tbl_studentinfo_manila.age = '$newStudent_age',
                                  tbl_studentinfo_manila.gender = '$newStudent_gender', 
                                  tbl_studentinfo_manila.contact_number = '$newStudent_contactNumber',  
                                  tbl_studentinfo_manila.email_address = '$newStudent_emailAdd'
        ...
        <br><br>
         ...
         <form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>?student_number=<?php echo $the_student_number; ?>" method="post">
           ...
           <?php 
              ...
              $query = "SELECT * FROM tbl_studentinfo_manila
                       WHERE tbl_studentinfo_manila.studentNo = '$the_student_number'";
