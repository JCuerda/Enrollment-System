<?php
    ...
    if( isset($_POST['btn_submit']) ){
      ...
      if( !$curriculum_id || !$course_id || !$course_description ){
          header('Location:create_course.php?alert=error');
      } else {

          $query = "INSERT INTO id701984_icc_enrollment.tbl_course_info (
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                               <select id="curriculum" name="curriculum" class="form-control">
                                                  ...
                                                  <?php 
                                                      $query_curriculum = "SELECT tbl_curriculum.curriculum_id FROM id701984_icc_enrollment.tbl_curriculum";
