                               ...
                               <div class="col-sm-12">
                                   <table class="table table-responsive table-bordered">
                                        ...
                                        <?php 
                                            ...
                                            $query = "SELECT tbl_subject.subject_code, tbl_subject.subject_description , tbl_subject.year_level , tbl_subject.semester_number , tbl_subject.units FROM tbl_subject , tbl_curriculum WHERE tbl_curriculum.curriculum_id = '$the_curriculum_id' AND tbl_subject.course_curriculum = '$the_curriculum_id' AND tbl_subject.year_level = 1 AND tbl_subject.semester_number = 2";
                                            $result = mysqli_query($conn,$query);
                                   ...
                                   <div class="col-sm-12">
                                       <table class="table table-responsive table-bordered">
                                            ...
                                            <?php 
                                                ...
                                                $query = "SELECT tbl_subject.subject_code, tbl_subject.subject_description , tbl_subject.year_level , tbl_subject.semester_number , tbl_subject.units FROM tbl_subject , tbl_curriculum WHERE tbl_curriculum.curriculum_id = '$the_curriculum_id' AND tbl_subject.course_curriculum = '$the_curriculum_id' AND tbl_subject.year_level = 2 AND tbl_subject.semester_number = 1";
                                                $result = mysqli_query($conn,$query);
                                   ...
                                   <div class="col-sm-12">
                                       <table class="table table-responsive table-bordered">
                                            ...
                                            <?php 
                                                ...
                                                $query = "SELECT tbl_subject.subject_code, tbl_subject.subject_description , tbl_subject.year_level , tbl_subject.semester_number , tbl_subject.units FROM tbl_subject , tbl_curriculum WHERE tbl_curriculum.curriculum_id = '$the_curriculum_id' AND tbl_subject.course_curriculum = '$the_curriculum_id' AND tbl_subject.year_level = 2 AND tbl_subject.semester_number = 2";
                                                $result = mysqli_query($conn,$query);
