...
$payment_query = "SELECT * FROM icc_prac3.tbl_payment_manila 
                ...
                <div class="row">
                    <div class="col-md-12"> 
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="view_pending_choose_branch.php">Pending Enrollment</a></li>
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-8">
                                ...
                                <a href="#" class="btn btn-success" role="button" onclick="javascript:printlayer('div-id-name')" style="margin-left: 450px;"> <i class="fa fa-print"></i>&nbsp;Print </a>
                                <a href="../admin/administration.php" class="btn btn-default" role="button"> Cancel</a>
                              </div>
                            </div>
