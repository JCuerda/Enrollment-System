<?php
    ...
    if( isset($_POST['btnSubmit']) ){
        ...
        if( $branch_id == 1 ){
            header('Location:create_student_login.php?branch_id='.$branch_id);
        } else {
            header('Location:create_student_login_manila.php?branch_id='.$branch_id);
        }
    }
        ...
        <div class="row">
            <div class="col-md-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="../admin/create_login_choose_branch.php">Choose Branch : Create Student Account</a></li>
                    </ol> 
            </div>
        </div>
              <?php echo  $errorMsg;  ?>
