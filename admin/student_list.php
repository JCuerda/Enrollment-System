                ...
                <div class="row">
                    <div class="col-md-12">
                      <ol class="breadcrumb">
                          ...
                          <li><a href="../admin/student_list.php">Reset Password</a></li>
                       ...
                       <?php include('admin_nav2.php'); ?>
                        ...
                        <div class="container-fluid">
                           ...
                           ?>
                                          ...
                                          <td class="text-center">
                                              <a href = "../admin/reset_password.php?id=<?php {echo $student_number; }?>" role="button"> <i class="fa fa-pencil-square"></i></a>
                                          </td>
