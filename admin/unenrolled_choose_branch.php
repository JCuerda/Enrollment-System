<?php
    ...
    if( isset($_POST['btnSubmit']) ){
        ...
        if( $branch_id == 1 ){
            header('Location:unenrolled_year.php?branch_id='.$branch_id.'&course_id='.$course_id.'&year_level='.$year_id);
        } else {
            header('Location:unenrolled_year_manila.php?branch_id='.$branch_id.'&course_id='.$course_id.'&year_level='.$year_id);
        }
    }
...
?>        
     <div class="container" id="mainContainer">
        <div class="row">
            <div class="col-md-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="../admin/unenrolled_choose_branch.php">Choose Branch</a></li>
                    </ol> 
            </div>
        </div>
              <?php echo  $errorMsg;  ?>
        ...
        <div class="panel-heading">View Unenrolled Students : Choose Branch and Year Level</div>
