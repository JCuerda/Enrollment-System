<?php 
 ...
 require('includes/connection');
  ...
  if( isset($_GET['student_number']) ){
      ...
      header('../admin/manage_choose_branch');
    }
...
if( isset($_POST['btn_completed']) ){
    ...
    while( list($key,$value) = @each($subject) ){
      // echo $value . "<br>";
      $update_query = "UPDATE icc_prac3.tbl_grades_manila , 
                      icc_prac3.tbl_studentinfo_manila
                      SET tbl_grades_manila.remarks = 'Completed',
                      tbl_studentinfo_manila.status = 'Not Enrolled'
                      WHERE tbl_studentinfo_manila.studentNo = '$student_number' 
                      AND tbl_grades_manila.studentNo = '$student_number' 
                      AND tbl_grades_manila.subject_code = '$value'";
...
// Update Student Remarks to "Failed"
  if( isset($_POST['btn_failed']) ){
    ...
    while( list($key,$value) = @each($subject) ){
      // echo $value . "<br>";
    $update_query = "UPDATE icc_prac3.tbl_grades_manila , icc_prac3.tbl_studentinfo_manila
                    SET tbl_grades_manila.remarks = 'Failed',
                    tbl_studentinfo_manila.status = 'Not Enrolled'
                    WHERE tbl_studentinfo_manila.studentNo = '$student_number' 
                    AND tbl_grades_manila.studentNo = '$student_number'
                    AND tbl_grades_manila.subject_code = '$value'";
...
// Update Student Remarks to "Incomplete"
  if( isset($_POST['btn_incomplete']) ){
    ...
    while( list($key,$value) = @each($subject) ){
      // echo $value . "<br>";
    $update_query = "UPDATE icc_prac3.tbl_grades_manila , icc_prac3.tbl_studentinfo_manila
                    SET tbl_grades_manila.remarks = 'Incomplete',
                    tbl_studentinfo_manila.status = 'Not Enrolled'
                    WHERE tbl_studentinfo_manila.studentNo = '$student_number' 
                    AND tbl_grades_manila.studentNo = '$student_number'
                    AND tbl_grades_manila.subject_code = '$value'";
  ...
  include('../admin/navigation_admin2');
       ...
       <div class="container" id="mainContainer">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                      <ol class="breadcrumb">
                          <li><a href="../admin/administration">Administration</a></li>
                          <li><a href="../admin/manage_choose_branch">Manage Student : Caloocan</a></li>
                               ...
                               <div class="col-sm-12">
                                   <table class="table table-responsive table-bordered">
                                        ...
                                        <tr>
                                          ...
                                          <td class="text-center">
                                             <a href="../admin/edit_scholarship_grant?student_number=<?php echo $student_number; ?>" role="button" ><i class="fa fa-pencil-square"></i></a> 
...
<!--                                       <th class="text-center">
                                ...
                                $query = "SELECT
                                              ...
                                              AND tbl_grades_manila.remarks !='Completed'
                                              ORDER BY FIELD(tbl_grades_manila.remarks, 'On-going', 'NOT ENROLLED' , 'Completed' ) , 
                                              tbl_grades_manila.subject_code ASC LIMIT 0, 10";
