    ...
    if( isset($_GET['alert']) ) {
        if($_GET['alert'] == 'blank_input'){
             ...
             $errorMsg = "<div class='row'><div class='col-md-12'><div class='alert alert-success'>
                        <strong>Enrollment Success! Please Proceed to the Cashier to Complete the Enrollment Process. Thank You<a class='close' data-dismiss='alert'>&times</a> </strong> 
                    </div></div></div>";
        }
      ...
      if( !$newStudent_courseID || !$newStudent_fName ||  !$newStudent_lastName ||  !$newStudent_mName || !$newStudent_address || !$newStudent_age || !$newStudent_gender || !$newStudent_contactNumber || !$newStudent_emailAdd){
          ...
          header('Location: enroll_now.php?alert=blank_input&branch='.$the_branch);
          ...
          header('Location: enroll_now.php?alert=invalid_name&branch='.$the_branch);
      } else if( !ctype_digit($newStudent_contactNumber) ){
          header('Location: enroll_now.php?alert=invalid_contact_number&branch='.$the_branch);
      } else {
          ...
          $errorMsg = "<div class='row'><div class='col-md-12' ><div class='alert alert-danger'>
           ...
           $curriculum_enrollment_query = "SELECT tbl_subject.subject_code, 
            ...
            $result = mysqli_query($conn,$curriculum_enrollment_query);
              ...
              header('Location: enroll_now.php?alert=enrollment_success&branch='.$the_branch); 
        }
...
?>
     ...
     <div class="panel panel-success">
        ...
        <div class="panel-heading"><strong>Enrollment Form</strong></div>
        ...
        <div class="panel-footer">
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                <button id="btnSubmit" name="btnSubmit" class="btn btn-success" style="margin-left: 200px;">Enroll Now</button>
