  ...
  $alertMessage = "";
    ...
    if( isset($_POST['btnSubmit']) ){
      ...
      */
      ...
      $payment_query = "INSERT INTO icc_prac3.tbl_payment_manila (
                        tbl_payment_manila.studentNo, 
                        tbl_payment_manila.account_name,
                        tbl_payment_manila.account_number,
                        tbl_payment_manila.depositor_fname,
                        tbl_payment_manila.depositor_Lname,
                        tbl_payment_manila.reference_code,
                        tbl_payment_manila.payment_amount,
                        tbl_payment_manila.date,
                        tbl_payment_manila.bdo_branch)
                        VALUES (
                        '$student_number',
                        '$icc_accountName',
                        '$icc_accountNumber',
      ...
      if( !$payment_result ){
        ...
        while( $row = mysqli_fetch_assoc($result) ){
          ...
          $update_query = "UPDATE icc_prac3.tbl_grades_manila
                           SET tbl_grades_manila.remarks = '$pointer'
                           WHERE tbl_grades_manila.subject_code = '$subject_code' 
         ...
         $studentInfoUpdate_query = "UPDATE icc_prac3.tbl_studentinfo_manila
                                    SET tbl_studentinfo_manila.status = '$student_flag',
                                    tbl_studentinfo_manila.year_level = '$subject_yrLevel',
                                    tbl_studentinfo_manila.semester_num = '$subject_semLevel'
                                    WHERE tbl_studentinfo_manila.studentNo = '$loggedUser'";
        ...
        if(!$studentInfo_result){
         ...
         header('Location: enrollment_done_manila.php?alert=success');
